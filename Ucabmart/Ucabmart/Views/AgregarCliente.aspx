<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarCliente.aspx.cs" Inherits="Ucabmart.Views.AgregarCliente" %>
...
<html lang="es">
    <head runat="server">
      ...
      <body id="page-top" class="bg-gradient-primary">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">      
                   <!-- Topbar Search -->
                    ...
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li ID="Clientes" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Clientes_Admin.aspx">Clientes</a></li>
                        <li ID="Tienda" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Tiendas-Admin.aspx">Tiendas</a></li>
                        <li ID="Productos" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Productos_Admin.aspx">Productos</a></li>
                        <li ID="Proveedores" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Proveedores.aspx">Proveedores</a></li>
                        <li ID="Nomina" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Nomina_Admin.aspx">Nomina</a></li>
                        <li ID="RolesA" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="Role/Role_Admin.aspx">Roles</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="Inicio_Admin.aspx">Inicio</a></li>
       ...
       <!-- Options -->
           <div class="option">Agregar Cliente</div>
              ...
              <div class="justify-content-center cut">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="tiendas-item">
                            <a class="tiendas-link" href="RegistrarClienteNatural.aspx">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tiendas-item">
                            <a class="tiendas-link" href="RegistrarClienteJuridico.aspx">
                                <div class="tiendas-hover">
                                    <div class="tiendas-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
