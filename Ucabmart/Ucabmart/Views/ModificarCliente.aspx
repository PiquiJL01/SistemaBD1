<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarCliente.aspx.cs" Inherits="Ucabmart.Views.ModificarCliente" %>
...
<html lang="es">
    <head runat="server">
      ...
      <body id="page-top" class="bg-gradient-primary">
       ...
       <!-- Options -->
           <div class="option">Modificar Cliente</div>
              ...
              <div class="justify-content-center cut">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="tiendas-item">
                            <a class="tiendas-link" href="ModificarClienteNatural.aspx">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="tiendas-item">
                            <a class="tiendas-link" href="ModificarClienteJuridico.aspx">
                                <div class="tiendas-hover">
                                    <div class="tiendas-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
