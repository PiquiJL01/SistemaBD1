<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrarEmpleado.aspx.cs" Inherits="Ucabmart.Views.Employee.RegistrarEmpleado" %>
...
<html lang="es">
    <head runat="server">
        ...
        <title>Ucabmart - Registrar Empleado</title>
        ...
        <link href="../../Content/css/RegistarEmpleado.css" rel="stylesheet" />
    </head>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">      
                   <!-- Topbar Search -->
                    ...
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li ID="Li1" class="nav-item" runat="server"><a class="nav-link js-scroll-trigger" href="/Views/Tiendas-Admin.aspx">Tiendas</a></li>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form id="form1" runat="server">
                                ...
                                <%--<Campo del Cargo - Departamento - Tienda - Jefe>--%>

                                 <div class="form-group" style="margin-bottom:20px; margin-top:30px">

                                    <asp:DropDownList ID="Cargos" runat="server" style="padding-bottom: 15px; background-color: #0f136bd6;color: white; width: 260px;" class="input-group-prepend be-addon">
                                   </asp:DropDownList>
                                 ...
                                 <div class="form-group" style="margin-bottom:20px; margin-top:50px">
                                   ...
                                   <asp:DropDownList ID="Tiendas" runat="server" style="padding-bottom: 15px; background-color: #0f136bd6;color: white; width: 260px;" class="input-group-prepend be-addon">
                                   </asp:DropDownList>

                                    <asp:DropDownList ID="Departamentos" runat="server" style="padding-bottom: 15px; margin-left: 280px; margin-top: -40px; background-color: #0f136bd6;color: white; width: 260px;" class="input-group-prepend be-addon">
                                   </asp:DropDownList>
                                ...
                                <div class="form-group">
                                         <asp:Label ID="Label11" runat="server" Text="Jefe"></asp:Label>
                                ...
                                <div class="form-group">
                                        <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></span>
                                            <asp:DropDownList ID="dplEstado" runat="server" style="padding:10px 50px 10px 50px; text-align: left; width: 505px;" class="input-group-prepend be-addon" OnSelectedIndexChanged="dplEstado_SelectedIndexChanged" AutoPostBack="True">
                                ...
                                <div class="form-group">
                                        <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></span>
                                            <asp:DropDownList ID="dplMunicipio" runat="server" style="padding:10px 50px 10px 50px; text-align: left; width: 505px;" class="input-group-prepend be-addon" AutoPostBack="True" OnSelectedIndexChanged="dplMunicipio_SelectedIndexChanged">
                                ...
                                <div class="form-group">
                                        <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></span>
                                            <asp:DropDownList ID="dplParroquia" runat="server" style="padding:10px 50px 10px 50px; text-align: left; width: 505px;" class="input-group-prepend be-addon">
                              ...
                              <div class="form-group" style="margin-bottom:20px; margin-top:30px">
                                  ...
                                  <%--<Hora de Inicio >--%>
                                   <div>
                                    ...
                                    <asp:TextBox ID="HoraInicio" runat="server" type="time" name="name" data-parsley-trigger="change"  
                                          placeholder="Hora Inicio" autocomplete="off" class="form-control" style="width:260px;">
                                    </asp:TextBox>
                                   </div>

                                    <br />
                                  <%--<Hora de Fin >--%>
                                  <div style="margin-left: 280px; margin-top: -84px;">
                                    <asp:Label ID="Label7" runat="server" Text="Hora de Fin"></asp:Label>
                                    <asp:TextBox ID="HoraFin" runat="server" type="time" name="name" data-parsley-trigger="change"  
                                          placeholder="Hora Fin" autocomplete="off" class="form-control" style="width:260px;">
                                   </asp:TextBox>
                                  </div>

                                    <br />
                                   <%--<Turnos >--%>
                                   <asp:DropDownList ID="Turno" runat="server" style="padding-bottom: 15px; background-color: #0f136bd6;color: white; width: 260px; margin-left: 130px;" class="input-group-prepend be-addon">
                                    ...
                                    <div style="margin-top: 20px;">
                                        ...
                                        <asp:Label ID="Label9" runat="server" Text="Dias del horario"></asp:Label>
                                        </div>
                                        <asp:CheckBoxList ID="Dias" runat="server" style="background-color:#4e73df; color: white; width: 540px; border-radius: 10px; padding: 10px 10px 10px 10px; " class="input-group-prepend be-addon">
                                ...
                                <hr>
                                <asp:Button ID="btnRegistrar" runat="server" class="btn btn-primary btn-user btn-block" Text="Registrar Empleado" OnClick="btnRegistrar_Click" />
