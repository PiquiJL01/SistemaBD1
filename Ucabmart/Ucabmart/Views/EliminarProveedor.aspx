<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarProveedor.aspx.cs" Inherits="Ucabmart.Views.EliminarProveedor" %>
...
<html lang="es">
    <head runat="server">
        ...
        <title>Ucabmart - Eliminar Proveedor</title>
    ...
    <body id="page-top" class="bg-gradient-primary">
        ...
        <!-- Options -->
           <div class="option">Eliminar Proveedor</div>
