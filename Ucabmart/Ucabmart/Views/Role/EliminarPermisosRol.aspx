<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarPermisosRol.aspx.cs" Inherits="Ucabmart.Views.Role.EliminarPermisos" %>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Eliminar Permisos</h1>
                            </div>
                            <form id="form1" runat="server">
                             ...
                             <%--<EMPLEADO>--%>
                              <div class="PC">
                                ...
                                <hr>
                                <asp:Button ID="Asignar" runat="server" class="btn btn-primary btn-user btn-block" Text="Eliminar Permisos" OnClick="btnEliminar_Click"/>
