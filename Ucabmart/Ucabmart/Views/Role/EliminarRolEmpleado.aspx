<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarRol.aspx.cs" Inherits="Ucabmart.Views.Role.EliminarRol" %>
...
<html lang="es">
    <head runat="server">
        ...
        <title>Ucabmart - Eliminar Rol Empleado</title>
    ...
    <body id="page-top" class="bg-gradient-primary">
        ...
        <!-- Options -->
           <div class="option">Eliminar Rol Empleado</div>
                            ...
                            <div class="p-5">                      
                                <div class="form-group">
                                    <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></span> 
                                        <asp:TextBox ID="txtEliminar" runat="server" placeholder="Ingrese el Rif del Empleado" Width="311px" ></asp:TextBox>  
