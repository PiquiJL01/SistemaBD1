<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearRol.aspx.cs" Inherits="Ucabmart.Views.Role.CrearRol" %>
...
<html lang="es">
    <head runat="server">
        ...
        <title>Ucabmart - Crear Rol</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Crear Rol</h1>
                            </div>
                              ...
                              <div class="PC">
                                ...
                                <div class="form-group" style="margin-bottom:40px; margin-top:20px;">
                                        ...
                                        <asp:TextBox ID="TxtNombre" runat="server" type="name" name="name" data-parsley-trigger="change"  
                                            placeholder="Ingrese el nombre del rol" autocomplete="off" class="form-control">
                                        </asp:TextBox>
                                </div>

                                <div class="form-group" style="margin-bottom:40px; margin-top:20px;">
                                         <asp:Label ID="Descripcion" runat="server" Text="Descripcion"></asp:Label>
                                        <asp:TextBox ID="TextDescripcion" runat="server" type="name" name="name" data-parsley-trigger="change"  
                                            placeholder="Ingrese el nombre del rol" autocomplete="off" class="form-control">
                                        </asp:TextBox>
                                </div>
