<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarClienteJuridico.aspx.cs" Inherits="Ucabmart.Views.ModificarClienteJuridico" %>
                    ...
                    <div>
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Modificar Cliente - Persona Jurídica</h1>
                            </div>
...
<%--                                        <asp:DropDownList ID="dplTipoCliente" runat="server" style="padding:10px 50px 10px 50px; text-align: left;" class="input-group-prepend be-addon">
                             ...
                             <%--<Datos del Cliente>--%>
                              <div style="margin-left: 100px; margin-right: 100px;">
                               ...
                               <%--<Pagina Web - Capital Disponible>--%>

                               <div class="Contacto" style="margin-bottom:20px; margin-top: 40px;">
                                 <asp:Label ID="Label9" runat="server" Text="Página Web - Capital Disponible"></asp:Label>
                               </div>
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label8" for="txtCapitalDisponible" runat="server" Text="Capital Disponible"></asp:Label>
                                 ...
                                 <%--<Rif - Correo - Contraseña>--%>

                                 <div class="Contacto" style="margin-bottom:20px; margin-top: 40px;">
                                    <asp:Label ID="Label10" runat="server" Text="Rif - Correo Electrónico - Contraseña"></asp:Label>
                                 </div>
                                ...
                                <div class="form-group row" style="margin-bottom: -20px;">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                         <asp:Label ID="Label25" runat="server" Text="Contraseña"></asp:Label>
