<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clientes_Admin.aspx.cs" Inherits="Ucabmart.Views.WebForm3" %>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="categorias-item">
                            ...
                            <div class="categorias-caption" style="margin-right:-68px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Agregar Cliente</div>
                                <div class="categorias-caption-subheading text-muted">Permite registrar a los nuevos clientes...</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4" style="margin-left: 120px">
                        <div class="categorias-item">
                            <a class="categorias-link" href="ConsultarClienteNatural.aspx">
                                <div class="categorias-hover">
                                    <div class="categorias-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                            ...
                            <div class="categorias-caption" style="margin-right:-69px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Consultar Cliente</div>
                                <div class="categorias-caption-subheading text-muted">Permite revisar los clientes registrados......</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4" style="box-sizing: initial">
                        <div class="categorias-item">
                            <a class="categorias-link" href="ModificarCliente.aspx">
                                <div class="categorias-hover">
                                    <div class="categorias-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                            ...
                            <div class="categorias-caption" style="margin-right:-44px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Modificar Cliente</div>
                                <div class="categorias-caption-subheading text-muted">Permite cambiar los datos de los clientes......</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4" style="margin-left: 100px">
                        <div class="categorias-item">
                            <a class="categorias-link" href="EliminarCliente.aspx">
                                <div class="categorias-hover">
                                    <div class="categorias-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                            ...
                            <div class="categorias-caption" style="margin-right:-68px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Eliminar Cliente</div>
                                <div class="categorias-caption-subheading text-muted">Permite eliminar la informacion de los clientes......</div>
                            </div>
                        </div>
                    </div>
                <div class="col-lg-4 col-sm-6 mb-4" style="box-sizing: initial">
                        <div class="categorias-item">
                            <a class="categorias-link" href="Reports/TopClientesMonto.aspx">
                                <div class="categorias-hover">
                                    <div class="categorias-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid2" src="../Content/assets/img/Provider/Consulting-Provider.jpg" alt="" />
                            ...
                            <div class="categorias-caption" style="margin-right:-69px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Top Clientes Montos</div>
                                <div class="categorias-caption-subheading text-muted">Permite revisar los clientes por montos......</div>
                            </div>
                        </div>
                    </div>
                <div class="col-lg-4 col-sm-6 mb-4" style="margin-left: 100px">
                        <div class="categorias-item">
                            <a class="categorias-link" href="Reports/OrdenDeCompraClientes.aspx">
                                <div class="categorias-hover">
                                    <div class="categorias-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid2" src="../Content/assets/img/Provider/Consulting-Provider.jpg" alt="" />
                            ...
                            <div class="categorias-caption" style="margin-right:-69px; background-color:#4e73dfd1">
                                <div class="categorias-caption-heading">Orden de Compras</div>
                                <div class="categorias-caption-subheading text-muted">Permite revisar las ordenes de compra de los clientes......</div>
                            </div>
                        </div>
                    </div>
            </div>
