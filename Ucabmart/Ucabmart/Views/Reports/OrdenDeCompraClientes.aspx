<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdenDeCompraClientes.aspx.cs" Inherits="Ucabmart.Views.Reports.OrdenDeCompra1" %>
            ...
            <div class="row" style="padding-left: 150px;">
             ...
             <form id="form1" runat="server">
                <div>
                    ...
                    <asp:ObjectDataSource ID="Ordenes" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByCliente" TypeName="Ucabmart.Views.Reports.OrdenDeCompraTableAdapters.CodigoPedidoTableAdapter">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList1" Name="cliente" PropertyName="SelectedValue" Type="Object" />
                        </SelectParameters>
                    </asp:ObjectDataSource>
